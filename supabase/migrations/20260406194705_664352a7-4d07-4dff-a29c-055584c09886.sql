...
-- Recreate subscribe_to_newsletter with 5 params (+ p_initial_tags)
...
-- Replace confirm_newsletter_subscription with auto-tagging
...
-- New RPC: add_tag_to_subscriber (admin-only, using has_role)
