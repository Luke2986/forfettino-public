-- Story 70-2: TTV Dashboard RPC
-- Calcola Time To Value (signup → primo incasso) con statistiche median/p90/p95,
-- breakdown per gestione INPS e trend giornaliero.

-- Index per accelerare JOIN receipts per user_id + created_at
