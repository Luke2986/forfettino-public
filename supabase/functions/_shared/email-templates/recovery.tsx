...
export const RecoveryEmail = ({
  ...
  <Html lang="it" dir="ltr">
    <Head />
    <Preview>Reimposta la tua password di Forfettino</Preview>
    <Body style={main}>
      <Container style={container}>
        <Text style={brand}>Forfettino</Text>
        <Heading style={h1}>Reimposta la password</Heading>
        <Text style={text}>
          Abbiamo ricevuto una richiesta di reimpostazione della password per il tuo account Forfettino. Clicca il pulsante qui sotto per scegliere una nuova password.
        </Text>
