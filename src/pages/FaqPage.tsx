...
import {
  faqPageItems,
  faqPageSources,
  FAQ_PAGE_PUBLISHED_DATE,
  FAQ_PAGE_MODIFIED_DATE,
} from "@/lib/faq-page";
import {
  AUTHOR_PERSON,
  AUTHOR_PERSON_REF,
...
const CANONICAL_URL = "https://forfettino.it/faq";
const PAGE_TITLE =
  "FAQ Regime Forfettario 2026 — Domande Frequenti | Forfettino";
const PAGE_DESCRIPTION =
  "Risposte a 16+ domande frequenti sul regime forfettario: limite 85.000 EUR, INPS, imposta sostitutiva, scadenze, coefficienti ATECO. Aggiornato 2026.";
const TLDR =
  "Il regime forfettario è il regime agevolato italiano per partite IVA con ricavi annui fino a 85.000 EUR (Legge 190/2014). Prevede imposta sostitutiva del 15% (5% i primi 5 anni) al posto di IRPEF, calcolata sul reddito imponibile ottenuto applicando il coefficiente ATECO. I contributi INPS sono 26,07% in Gestione Separata, circa 24% per artigiani e commercianti.";
...
export default function FaqPage() {
  const webPageNode = {
    ...
    description: TLDR,
    inLanguage: "it-IT",
    datePublished: FAQ_PAGE_PUBLISHED_DATE,
    dateModified: FAQ_PAGE_MODIFIED_DATE,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
        ...
        <p className="mt-6 text-sm text-slate-600">
          Risposte aggiornate al 2026 alle domande più frequenti su regime
          forfettario, contributi INPS, imposta sostitutiva, scadenze, ATECO e
          agevolazioni. Fonti ufficiali in fondo alla pagina.
        </p>
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="mx-auto max-w-3xl px-4 text-center text-sm text-slate-600">
          ...
          <nav aria-label="Footer FAQ" className="mt-2">
